                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="white-box">
                                <h3 class="box-title font-weight-bold">تعديل {{$TheExpens->title}}</h3>
                                <form class="form-horizontal form-material" action="{{route('expenses.edit.post' , $TheExpens->id)}}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <select class="form-control" name="type" required>
                                                <option value="{{$TheExpens->type}}">{{$TheExpens->type_text}}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="6" placeholder="أدخل الملاحظات المطلوبة" name="notes" class="form-control form-control-line">{{$TheExpens->notes}}</textarea>
                                         </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
